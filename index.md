    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
          ...
          <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#about">关于我们</a></li>
        
          <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#timeline">荣誉墙</a></li>
        
          <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#team">闪耀成员</a></li>
        
          <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#contact">其他</a></li>
        
          <li class="nav-item"><a class="nav-link js-scroll-trigger" href="https://github.com/raviriley/agency-jekyll-theme/">Theme Source</a></li>
...
<section class="page-section bg-light" id="events">
  <div class="container">
      <div class="text-center">
          <h2 class="section-heading text-uppercase">比赛介绍</h2>
          <h3 class="section-subheading text-muted">探索我们工作室的精彩比赛活动。</h3>
      </div>
      <div class="text-center">
        <h2 class="section-heading text-uppercase">往期回顾</h2>
      </div>
      <div class="row">
          <!-- 比赛1 -->
          <div class="col-lg-4 col-sm-6 mb-4">
              <div class="portfolio-item">
                  ...
                  <div class="portfolio-caption">
                      <div class="portfolio-caption-heading">挑战杯</div>
                      <div class="portfolio-caption-subheading text-muted">挑战极限，创造奇迹</div>
                  </div>
              </div>
          </div>
          <!-- 比赛2 -->
          <div class="col-lg-4 col-sm-6 mb-4">
              <div class="portfolio-item">
                  <a class="portfolio-link" data-bs-toggle="modal" href="#eventModal2">
                      ...
                      <img class="img-fluid" src="assets/img/active/机器人与人工智能大赛.png" alt="机器人与人工智能大赛" />
                  </a>
                  <div class="portfolio-caption">
                      <div class="portfolio-caption-heading">中国机器人及人工智能大赛</div>
                      <div class="portfolio-caption-subheading text-muted">中国机器人及人工智能大赛始于1999年，是一项历史悠久、规模宏大、
                        影响广泛的全国性机器人竞赛。该赛事旨在培养学生解决实际问题的能力，促进理论与实践的融合，培养学生的协作精神和创新能力。</div>
                  </div>
              </div>
          </div>
          <!-- 比赛3 -->
          <div class="col-lg-4 col-sm-6 mb-4">
              <div class="portfolio-item">
                  ...
                  <div class="portfolio-caption">
                      <div class="portfolio-caption-heading">互联网+</div>
                      <div class="portfolio-caption-subheading text-muted">以赛促教，探索人才培养新途径。全面提高人才自主培养质量，强化高校课程思政建设，深入推 …
                        以赛促学，培养创新创业生力军。着力造就拔尖创新人才，激励广大青年扎根中国大地了解国情民情，在创新创业中增长智慧才干，怀抱梦想又脚踏实地，
                        敢想敢为又善作善成，做有理想、敢担当、能吃苦、肯奋斗的新时代好青年。</div>
                  </div>
              </div>
          </div>
          <div class="col-lg-4 col-sm-6 mb-4">
      ...
      <div class="text-center">
        <h2 class="section-heading text-uppercase">即将开始</h2>
      </div>
  </div>
</section>
              ...
              <div class="row justify-content-center">
                  <div class="col-lg-8">
                      <div class="modal-body">
                          <h2>编程马拉松</h2>
                          <p class="item-intro text-muted">在限定时间内解决尽可能多的编程问题。</p>
                          <img class="img-fluid d-block mx-auto" src="assets/img/events/event1.jpg" alt="编程马拉松" />
                          <p>参与编程马拉松，与志同道合的朋友一起，在48小时内完成一个项目或解决一系列挑战。这不仅考验了你的技术能力，还锻炼了团队合作精神。</p>
    ...
    <div class="row">
      ...
      <div class="col-md-4 col-sm-6 portfolio-item">
        <a class="portfolio-link" data-toggle="modal" href="#p2">
          ...
          <img class="img-fluid" src="https://raw.githubusercontent.com/BlackrockDigital/startbootstrap-agency/master/src/assets/img/portfolio/01-thumbnail.jpg" alt="">
        </a>
        <div class="portfolio-caption">
          <h4>Threads</h4>
      ...
      <div class="col-md-4 col-sm-6 portfolio-item">
        <a class="portfolio-link" data-toggle="modal" href="#p3">
          ...
          <img class="img-fluid" src="https://raw.githubusercontent.com/BlackrockDigital/startbootstrap-agency/master/src/assets/img/portfolio/02-thumbnail.jpg" alt="">
        </a>
        <div class="portfolio-caption">
          <h4>Explore</h4>
        ...
        <div class="row">
          <div class="col-lg-8 mx-auto">
            <div class="modal-body">
              ...
              <img
                class="img-fluid d-block mx-auto"
                src="https://raw.githubusercontent.com/BlackrockDigital/startbootstrap-agency/master/src/assets/img/portfolio/01-full.jpg"
        ...
        <div class="row">
          <div class="col-lg-8 mx-auto">
            <div class="modal-body">
              ...
              <img
                class="img-fluid d-block mx-auto"
                src="https://raw.githubusercontent.com/BlackrockDigital/startbootstrap-agency/master/src/assets/img/portfolio/02-full.jpg"
                alt="Keep Exploring"
              />
...
<!-- About -->
  ...
  <section class="bg-light page-section" id="timeline">
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase"><p>荣誉墙</p>
</h2>
          <h3 class="section-subheading text-muted">展出荣誉</h3>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-12">
      ...
      <div class="row" >
        ...
        <div class="col-md-3 col-sm-6">
          <a href="https://github.com/raviriley/agency-jekyll-theme">
            <img class="img-fluid d-block mx-auto" src="assets/img/clients/envato.jpg" alt="envato" style="max-height: 100px">
          </a>
        </div>
	    
        <div class="col-md-3 col-sm-6">
          <a href="https://github.com/raviriley/agency-jekyll-theme">
            <img class="img-fluid d-block mx-auto" src="assets/img/clients/designmodo.jpg" alt="designmodo" style="max-height: 100px">
          </a>
        </div>
	    
        <div class="col-md-3 col-sm-6">
          <a href="https://github.com/raviriley/agency-jekyll-theme">
            <img class="img-fluid d-block mx-auto" src="assets/img/clients/themeforest.jpg" alt="themeforest" style="max-height: 100px">
          </a>
        </div>
	    
        <div class="col-md-3 col-sm-6">
          <a href="https://github.com/raviriley/agency-jekyll-theme">
            <img class="img-fluid d-block mx-auto" src="assets/img/clients/creative-market.jpg" alt="Creative Market" style="max-height: 100px">
          </a>
        </div>
